...
class CarInfosForm(forms.Form):
    ...
    KM = [
        ("5000-10000", "5 000 - 10 000 km/an"),
        ("10000-15000", "10 000 - 15 000 km/an"),
        ("15000-20000", "15 000 - 20 000 km/an"),
        ("20000-25000", "20 000 - 25 000 km/an"),
        ("25000-30000", "25 000 - 30 000 km/an")
    ]
